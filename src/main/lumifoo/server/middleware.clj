(ns lumifoo.server.middleware
  (:require [lumifoo.server.env :refer [defaults]]
            [cheshire.generate :as cheshire]
            [cognitect.transit :as transit]
            [clojure.tools.logging :as log]
            [lumifoo.server.layout :refer [*app-context* error-page]]
            ...
            [lumifoo.server.config :refer [env]]
